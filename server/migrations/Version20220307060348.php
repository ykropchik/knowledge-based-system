 ...
 */
final class Version20220307060348 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE price_class_attribute_attribute ADD CONSTRAINT FK_CC6AF2FC1CC293DE FOREIGN KEY (price_class_attribute_id) REFERENCES price_class_attribute (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE price_class_attribute_attribute ADD CONSTRAINT FK_CC6AF2FCB6E62EFA FOREIGN KEY (attribute_id) REFERENCES attribute (id) ON UPDATE NO ACTION ON DELETE CASCADE');
